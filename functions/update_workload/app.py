"""
    Update a Stax workload and return response data containing workload and task information
"""
import logging
...
xray_recorder.configure(service="StaxOrchestrator:UpdateWorkload")
patch_all()
